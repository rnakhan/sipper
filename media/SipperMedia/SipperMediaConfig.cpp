...
LOG("SipperMediaConfig");
#include "SipperMediaConfig.h"

SipperMediaConfig * SipperMediaConfig::_instance = NULL;


SipperMediaConfig & SipperMediaConfig::getInstance()
{
   if(_instance == NULL)
   {
      _instance = new SipperMediaConfig();
   }

   return *_instance;
}

SipperMediaConfig::SipperMediaConfig()
{

}

void SipperMediaConfig::loadConfigFile(const std::string &configFile)
{
   MutexGuard(&_mutex);
...
std::string SipperMediaConfig::getConfig(const std::string &section, 

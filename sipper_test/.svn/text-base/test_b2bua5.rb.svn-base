...
class TestB2bua5 < DrivenSipTestCase
  ...
  def setup
    ...
    module TestB2bua5_SipInline
      ...
      class UacB2buaController < SIP::SipTestDriverController
        ...
        def on_success_res_for_bye(session)
          session.invalidate(true)
          session.flow_completed_for("TestB2bua5")
        end
    ...
    set_controller("TestB2bua5_SipInline::UacB2buaController")
  end

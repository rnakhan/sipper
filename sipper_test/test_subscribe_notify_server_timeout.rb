...
class TestSubscribeNotifyServerTimeout < DrivenSipTestCase
  ...
  def setup
    ...
    module TestSubscribeNotifyServerTimeout_SipInline
      class Uas2xxController < SIP::SipTestDriverController
        ...
        def on_success_res(session)
          ...
          if session['closeState'] == 1
             session.invalidate
             session.flow_completed_for("TestSubscribeNotifyServerTimeout")  
          end
        end
    ...
    set_controller("TestSubscribeNotifyServerTimeout_SipInline::Uac2xxController")
  end
